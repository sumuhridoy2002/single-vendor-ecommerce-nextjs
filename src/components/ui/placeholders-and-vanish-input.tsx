...
type ParticlePoint = { x: number; y: number; r: number; color: string };
...
export function PlaceholdersAndVanishInput({
  ...
  const wrapperClassName = cn(
    "w-full relative overflow-hidden transition duration-200",
    value && "bg-gray-50",
    embedded && "max-w-none"
  );
  ...
  const content = (
    <>
      ...
      <input
        ...
        type="search"
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border-none dark:text-white bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 pl-4",
