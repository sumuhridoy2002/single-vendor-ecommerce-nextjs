                  ...
                  <SidebarMenuItem key={item.label}>
                    ...
                    >
                      ...
                      >
                        <Link
                          href={categoryPath}
                          className="flex flex-1 min-w-0 items-center gap-2 transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
                        >
                        ...
                        <CollapsibleTrigger asChild>
                          <button
                            ...
                            className="flex shrink-0 items-center justify-center py-3 pr-3 transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                          >
                            ...
                            return (
                              <SidebarMenuSubItem key={sub.label}>
                                <SidebarMenuSubButton
                                  ...
                                  className="h-auto border-b border-sidebar-border rounded-none py-2.5 pl-12 pr-3"
                                >
                                  <Link
                                    href={subPath}
