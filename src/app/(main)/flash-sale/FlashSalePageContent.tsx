...
export function FlashSalePageContent({ initialProducts }: FlashSalePageContentProps) {
  ...
  const filteredProducts = useMemo(() => {
    ...
    const discountMin =
      discountParam != null && discountParam !== ""
        ...
        : null;
    let result = filterByPrice(initialProducts, priceMin, priceMax);
      ...
      <div className="flex w-full gap-6">
        <div className="hidden w-56 shrink-0 lg:block">
          <SearchFiltersSidebar
            searchResultSet={initialProducts}
